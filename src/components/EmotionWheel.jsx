...
const MultiRingWheel = memo(function MultiRingWheel({ data, size = 320, onSelect }) {
 ...
 {/* العجلة */}
 <div 
 className="relative rounded-full shadow-xl border-8 border-white bg-bg-surface transition-all duration-500"
 style={{ 
 ...
 className="absolute top-4 right-4 bg-bg-surface rounded-full p-2 shadow-lg"
 >
