...
>
  <Settings className="w-5 h-5" />
      ...
      <p className="text-base font-normal leading-normal text-center px-4 pt-1 pb-3 text-[#0e1b15]">Welcome back, Amelia! Continue your journey towards a healthier you.</p>
