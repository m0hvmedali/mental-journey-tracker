  ...
  return (
    <div className="flex flex-col min-h-screen themed-bg" style={{ fontFamily: 'Lexend, Noto Sans, sans-serif' }}>
      ...
      <header className="flex items-center p-4 pb-2">
        ...
        <h2 className="flex-1 text-center pr-12 text-lg font-bold themed-text">Self‑Compassion</h2>
      </header>

      <main className="flex-1 overflow-y-auto px-4 pb-10 space-y-6">
        {/* Intro */}
        <section>
          <h1 className="text-[22px] font-bold themed-text pb-1">What is Self‑Compassion?</h1>
          <p className="text-base themed-text leading-relaxed">
        ...
        {/* Core Components */}
        <section>
          <h2 className="text-lg font-bold themed-text">3 Components (by Kristin Neff)</h2>
        ...
        {/* Exercises */}
        <section>
          <h2 className="text-lg font-bold themed-text">Practical Exercises</h2>
          <div className="space-y-4 mt-2">
        ...
        {/* Quote */}
        <section className="bg-[#e9f1ee] dark:bg-[#1a2820] rounded-xl p-4 border border-[#d3e3dc] dark:border-[#2a3e32] flex gap-3 items-start">
          <Quote className="text-[#4e9778]" size={24} />
          <p className="text-sm themed-text italic">
        ...
        {/* Resources */}
        <section>
          <h2 className="text-lg font-bold themed-text">Learn More</h2>
...
function Item({ icon, title, desc }) {
  return (
    <div className="flex items-start gap-3">
      <div className="size-10 flex items-center justify-center themed-bg-subtle rounded-lg text-[#4e9778]">{icon}</div>
      <div>
        <p className="font-semibold themed-text">{title}</p>
...
function Exercise({ title, desc }) {
  return (
    <div className="border themed-border rounded-xl p-4 themed-bg-card">
      <p className="font-semibold themed-text mb-1">{title}</p>
      <p className="text-sm themed-text-muted">{desc}</p>
    </div>
  );
}
...
function Resource({ icon, title, url }) {
  return (
    <a href={url} target="_blank" rel="noopener noreferrer" className="flex items-center gap-3 themed-bg-subtle rounded-xl px-3 py-2 text-sm themed-text hover:opacity-85 transition-opacity">
      {icon}
      <span>{title}</span>
    </a>
  );
