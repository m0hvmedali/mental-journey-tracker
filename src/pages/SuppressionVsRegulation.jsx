...
export default function SuppressionVsRegulationPage() {
 ...
 <h2 className="flex-1 text-center pr-12 text-lg font-bold text-text-primary"> Suppression VS Regulation </h2>
 </header> 
 ...
 {/* ملاحظة */}
 <Card className="bg-bg-surface shadow-md lg:col-span-2">
 <CardHeader className="flex items-center space-x-2">
