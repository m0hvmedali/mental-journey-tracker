...
export default function CBTPage() {
 ...
 <button onClick={() => window.history.back()} className="flex size-12 shrink-0 items-center text-text-primary">
 ...
 <h2 className="flex-1 text-center pr-12 text-lg font-bold text-text-primary">Cognitive behavioral therapy </h2>
 </header>
 {/* شريط الاختصارات */}
 ...
 key={skill.id}
 href={`#${skill.id}`}
 className="flex-shrink-0 px-3 py-1 bg-bg-surface text-text-primary rounded-full text-sm border shadow-lg transition 
 ...
 {/* نموذج الفلترة */}
 <Card id="filterModel" className="bg-bg-surface shadow-md col-span-full">
 ...
 <Card id="triangle" className="bg-bg-surface shadow-md col-span-full">
 <CardHeader className="flex items-center space-x-2">
 ...
 {/* مهارة السندوتش */}
 <Card id="sandwich" className="bg-bg-surface shadow-md col-span-full">
 <CardHeader className="flex items-center space-x-2">
 ...
 <Card id="socratic" className="bg-bg-surface shadow-md col-span-full">
 <CardHeader className="flex items-center space-x-2">
 ...
 {/* 1. التعرض المنهجي */}
 <Card id="exposure" className="bg-bg-surface shadow-md">
 <CardHeader className="flex items-center space-x-2">
 ...
 {/* 2. التنشيط السلوكي */}
 <Card id="activation" className="bg-bg-surface shadow-md">
 <CardHeader className="flex items-center space-x-2">
 ...
 <Card id="shaping" className="bg-bg-surface shadow-md">
 <CardHeader className="flex items-center space-x-2">
 ...
 {/* 4. لعب الأدوار */}
 <Card id="role" className="bg-bg-surface shadow-md">
 <CardHeader className="flex items-center space-x-2">
 ...
 {/* 5. تمارين الاسترخاء */}
 <Card id="relaxation" className="bg-bg-surface shadow-md">
 <CardHeader className="flex items-center space-x-2">
 ...
 {/* 6. حل المشكلات */}
 <Card id="problem-solving" className="bg-bg-surface shadow-md">
 <CardHeader className="flex items-center space-x-2">
 <Triangle className="w-6 h-6 text-indigo-500" />
 ...
 {/* 7. التدريب على الحزم */}
 <Card id="assertiveness" className="bg-bg-surface shadow-md">
 <CardHeader className="flex items-center space-x-2">
 ...
 <Card id="applications" className="bg-bg-surface shadow-md col-span-full">
 <CardHeader className="flex items-center space-x-2">
